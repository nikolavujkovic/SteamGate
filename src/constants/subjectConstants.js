export default {
  ...
  anatomy: {
    ...
    subjectDescription: 'Upoznajte se sa vitalnim organima čovjeka!',
  ...
  astronomy: {
    ...
    subjectDescription: 'Uplovite u svijet nebeskih tijela!',
  ...
  botany: {
    ...
    subjectDescription: 'Naučite prepoznati različite vrste biljaka!',
  ...
  electronics: {
    ...
    subjectDescription: 'Zavirite u strukturu elektronskih dijelova!',
  ...
  chemistry: {
    subjectName: 'Hemija',
    subjectDescription: 'Pogledajte molekule hemijskih jedinjenja!',
  ...
  microbiology: {
    ...
    subjectDescription: 'Saznajte nešto više o strukturi mikro-svijeta!',
  ...
  zoology: {
    ...
    subjectDescription: 'Proučite građu tijela različitih vrsta životinja!',
